    ...
    return (
        <Container>
                        ...
                        {requests.map((request, index) => (
                            request.request_status === 'production' && (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>
                                        <CustomButton1 onClick={() => handleProductionOpen(request)} >Production</CustomButton1>
                                    </TableCell>
                                </TableRow>
                            )
                        ))}
            ...
            <Dialog open={isProductionDialogOpen} onClose={handleCloseProduction}>
                ...
                <DialogContent>
                    <ProductionForm initialValues={selectedRequest}  onSubmit={handleProductionRequestion}></ProductionForm>
                </DialogContent>
                <DialogActions>
