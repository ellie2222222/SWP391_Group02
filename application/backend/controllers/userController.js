...
const loginUser = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ user_id: user._id, username: user.username, email, token, role: user.role });
  } catch (error) {
...
const signupUser = async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ user_id: user._id, username, email, token, role: user.role });
  } catch (error) {
