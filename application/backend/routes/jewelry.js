...
const { requireAdminOrManagerOrSaleOrDesign } = require('../middleware/requireRoles');
...
jewelryRoutes.post('/', requireAuth, requireAdminOrManagerOrSaleOrDesign, upload.array('images', 5), createJewelry); // Handle multiple file uploads with field name 'images' and max 5 files
